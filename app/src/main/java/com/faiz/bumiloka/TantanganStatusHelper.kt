...
object TantanganStatusHelper {
    ...
    fun isMasterKuisSelesai(context: Context): Boolean {
        ...
        val quiz1 =
            pref.getBoolean("materi1_selesai", false)

        val quiz2 =
            pref.getBoolean("quiz2_selesai", false)

        val quiz3 =
            pref.getBoolean("quiz3_selesai", false)

        val nilai1 =
            pref.getInt("nilai_materi1", 0)

        val nilai2 =
            pref.getInt("quiz2_nilai", 0)

        val nilai3 =
            pref.getInt("quiz3_nilai", 0)
